												...
												<div class="card-body pt-5">
													...
													<div class="d-flex flex-column gap-5">
														...
														<div class="d-flex flex-stack">
															<a href="../../demo1/dist/apps/contacts/getting-started.html" class="fs-6 fw-bold text-gray-800 text-hover-primary">Call Log</a>
															<div class="badge badge-light-primary">9</div>
														</div>
														<!--begin::Contact group-->
														<!--begin::Contact group-->
														<div class="d-flex flex-stack">
															<a href="../../demo1/dist/apps/contacts/getting-started.html" class="fs-6 fw-bold text-gray-800 text-hover-primary">Transcript Search</a>
															<div class="badge badge-light-primary">3</div>
														</div>
														<!--begin::Contact group-->
														<!--begin::Contact group-->
														<div class="d-flex flex-stack">
															<a href="../../demo1/dist/apps/contacts/getting-started.html" class="fs-6 fw-bold text-gray-800 text-hover-primary">Unique Callers</a>
															<div class="badge badge-light-primary">1</div>
														</div>
														<!--begin::Contact group-->
														<!--begin::Contact group-->
														<div class="d-flex flex-stack">
															<a href="../../demo1/dist/apps/contacts/getting-started.html" class="fs-6 fw-bold text-gray-800 text-hover-primary">Voicemail</a>
															<div class="badge badge-light-primary">3</div>
														</div>
														<!--begin::Contact group-->
													</div>
													...
													<div class="d-flex flex-column gap-5">
														...
														<!--begin::Contact group-->
														<div class="d-flex flex-stack">
															<a href="../../demo1/dist/apps/contacts/getting-started.html" class="fs-6 fw-bold text-gray-800 text-hover-primary">Text Conversations</a>
															<div class="badge badge-light-primary">9</div>
														</div>
													</div>
													<div class="separator my-7"></div>
													...
													<div class="d-flex flex-column gap-5">
														...
														<!--begin::Contact group-->
														<div class="d-flex flex-stack">
															<a href="../../demo1/dist/apps/contacts/getting-started.html" class="fs-6 fw-bold text-gray-800 text-hover-primary">Form Submissions</a>
															<div class="badge badge-light-primary">9</div>
														</div>
														<!--begin::Contact group-->
														<!--begin::Contact group-->
														<div class="d-flex flex-stack">
															<a href="../../demo1/dist/apps/contacts/getting-started.html" class="fs-6 fw-bold text-gray-800 text-hover-primary">Search Submissions</a>
															<div class="badge badge-light-primary">3</div>
														</div>
														<!--begin::Contact group-->
													</div>
													...
													<div class="d-flex flex-column gap-5">
														...
														<!--begin::Contact group-->
														<div class="d-flex flex-stack">
															<a href="../../demo1/dist/apps/contacts/getting-started.html" class="fs-6 fw-bold text-gray-800 text-hover-primary">Chat Log</a>
															<div class="badge badge-light-primary">9</div>
														</div>
													</div>
													<!--end::Contact groups-->
