									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
												...
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-5" href="{{ route('client.agent-view') }}">Agent View</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="{{ route('client.team-view') }}">Team View</a>
												</li>
												<!--end::Nav item-->
										</ul>
										<!--end::Breadcrumb-->
									...
									<div class="row g-7">
										...
										<div class="col-lg-6 col-xl-3">
											...
											<div class="card card-flush">
												<div class="card-header pt-7" id="kt_chat_contacts_header">
													<div class="card-title">
														<h2>Track your call queues in real time</h2>
													</div>
												</div>
												<!--begin::Card body-->
												<div class="card-body pt-5">
													...
													<div class="d-flex flex-column gap-5">
														<!--begin::Contact group-->
														<div class="d-flex flex-stack">
															<span>Get an up-to-the-second view of team performance with real-time call queue metrics.</span>
														</div>
														<!--begin::Contact group-->
														<!--begin::Contact group-->
														<div class="d-flex flex-stack">
															<span>Pick a team from the panel to the far left and you’ll see stats associated with their call queues here. If you don’t have any teams, consider <a href="">creating one</a>.</span>
														</div>
													</div>
													<div class="separator my-7"></div>
													<!--end::Contact groups-->
